...
Wir fordern ein Verbot von leistungsfähigeren allgemeinen KI-Systemen, bis wir wissen, wie wir beweisbar sichere KI bauen können und wir sie unter demokratischer Kontrolle haben.
...
KI-Sicherheitsforscher (die Experten auf diesem Gebiet) sind geteilt in dieser Frage, und Schätzungen [reichen von 2% bis 97% mit einem Durchschnitt von 30%](https://web.archive.org/web/20221013014859/https://www.alignmentforum.org/posts/QvwSr5LsxyDeaPK5s/existential-risk-from-ai-survey-results).
...
Ihre Strategie ist jedoch ziemlich explizit: Eine Pause ist unmöglich, wir müssen zuerst superintelligent werden.
...
- Am 30. Mai wurde die [Safe.ai-Erklärung (Anerkennung des existenziellen Risikos)](https://www.safe.ai/statement-on-ai-risk) veröffentlicht. Diesmal einschließlich Leute von OpenAI, Google und Microsoft.
...
Also sehen wir es so: Die KI-Unternehmen drängen die existenzielle Risiko-Erzählung nicht voran, sie haben reagiert, als andere sie vorangetrieben haben, und haben mit ihrer Antwort gewartet, bis es absolut notwendig war.
