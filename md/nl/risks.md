Ik heb mijn vertaling naar het Nederlands herzien en verbeterd waar nodig. Hieronder vindt u de herziene vertaling:
...
Een pauze in de ontwikkeling van de krachtigste KI-modellen (onze [voorstellen](/proposal)) zou de modellen die tegenwoordig worden gebruikt om nepmedia te creëren niet stoppen, maar het zou kunnen helpen om toekomstige, geavanceerde modellen te voorkomen.
...
U kunt een compilatie van KI-incidenten vinden, die voornamelijk deepfake-nieuws, oplichting en intimidatie zijn, [hier](https://incidentdatabase.ai/summaries/incidents/).
...
Zwarte patiënten werden [minder snel doorverwezen naar een medisch specialist](https://www.science.org/doi/full/10.1126/science.aax2342).
Bevooroordeelde systemen die worden gebruikt in wetshandhaving, zoals voorspellende politiealgoritmes, kunnen leiden tot oneerlijke doelgerichtheid van specifieke groepen.
...
GPT-4 is [geslaagd voor het advocaatsexamen](https://law.stanford.edu/2023/04/19/gpt-4-passes-the-bar-exam-what-that-means-for-artificial-intelligence-tools-in-the-legal-industry/), kan uitstekende geschreven inhoud creëren en kan code schrijven (opnieuw, gedeeltelijk getraind op [auteursrechtelijk beschermd materiaal](https://www.ischool.berkeley.edu/news/2023/new-research-prof-david-bamman-reveals-chatgpt-seems-be-trained-copyrighted-books)).
...
Milieuschade begint significant te worden, en de grootste KI-bedrijven zijn van plan om hun energieverbruik aanzienlijk te verhogen. U kunt hier lezen hoe KI het milieu negatief zal beïnvloeden [/environmental].
...
Maar naarmate de mogelijkheden van deze KI-systemen verbeteren, zal er steeds meer druk zijn om de machines de macht te geven om te beslissen.
Wanneer we de controle over wapens aan KI delegeren, kunnen fouten en bugs verschrikkelijke gevolgen hebben.
De snelheid waarmee KI informatie kan verwerken en beslissingen kan nemen, kan ertoe leiden dat conflicten in enkele minuten escaleren.
Een [recent artikel](https://arxiv.org/pdf/2401.03408.pdf) concludeert dat "modellen de neiging hebben om een wapenwedloopdynamiek te ontwikkelen, wat leidt tot grotere conflicten, en in zeldzame gevallen zelfs tot de inzet van kernwapens".
...
> Binnen een uur stelden de chatbots vier potentiële pandemische pathogenen voor, legden uit hoe ze kunnen worden gegenereerd uit synthetisch DNA met behulp van reverse genetica, leverden de namen van DNA-synthesemaatschappijen die waarschijnlijk geen bestellingen zullen screenen, identificeerden gedetailleerde protocollen en hoe ze kunnen worden opgelost, en adviseerden iedereen die niet over de vaardigheden beschikt om reverse genetica uit te voeren, een kernfaciliteit of contractonderzoeksorganisatie in te schakelen.
...
Hoogwaardige computervirussen zijn altijd extreem moeilijk te creëren geweest, maar KI kan dat veranderen.
...
### Existentiële risico's {#existential-risk}
...
Het zou een beschaving zijn waarin elk systeem wordt geoptimaliseerd voor verschillende doelstellingen, er is geen duidelijke richting waarin alles zich beweegt, en er is geen manier om het te veranderen.
...
De systemen kunnen hun doelen bereiken, maar die doelen kunnen onze waarden niet volledig omvatten. Dit probleem doet zich nu al voor, maar KI kan het aanzienlijk versterken.
...
Als de KI's blijven worden geproduceerd met alleen hun capaciteiten in gedachten, via een proces dat we niet volledig begrijpen, zullen mensen de KI's blijven gebruiken als gereedschap, zonder rekening te houden met wat hun verlangens zouden kunnen zijn, en dat ze eigenlijk "digitale mensen" zouden kunnen knechten.

### Lijden-risico's {#suffering-risks}

Het is niet alleen dat waardevergrendeling ons kan doen falen om de beste soort werelden te bereiken, maar het kan ons ook doen eindigen in dystopieën die erger zijn dan uitsterven en die zich kunnen uitstrekken over de hele ruimte-tijd.

Mogelijke vergrendelde dystopieën met veel lijden worden _S-risico's_ genoemd en omvatten werelden waarin bewuste wezens worden geknecht en gedwongen worden om vreselijke dingen te doen.
...
Ik heb enkele kleine aanpassingen gemaakt om de vertaling vloeiender en natuurlijker te maken. Ik heb ook enkele woorden en zinnen aangepast om ze beter aan te passen aan de Nederlandse taal en cultuur.