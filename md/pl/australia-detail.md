---
title: PauseAI Australia (Nasze kampanie)
slug: australia-detail
description: Więcej informacji o australijskim oddziale PauseAI
---
...
>
> – Alan Finkel, były główny naukowiec Australii (2016–2020)
>
...
Historia pokazuje, że mniejsze kraje mogą mieć duży wpływ na rozwiązywanie globalnych problemów. Weźmy pod uwagę zakaz polowań na wieloryby z 1982 roku i porozumienie z 1987 roku w sprawie ochrony warstwy ozonowej. Australia, która sama kiedyś polowała na wieloryby, stała się liderem w ochronie życia oceanicznego, popierając zakaz i nawet wnosząc sprawę przeciwko Japonii do sądu z powodu jej polowań na wieloryby. Australia również pomogła chronić środowisko, szybko przystępując do porozumienia o zaprzestaniu używania substancji szkodzących warstwie ozonowej. Te historie pokazują, że kraje takie jak Australia mogą sprawić, że realne zmiany nastąpią na świecie, podejmując działania i współpracując z innymi narodami.

### Czy nie ma ważniejszych problemów? {#arent-there-more-important-issues}

Zgadzamy się, że istnieje wiele ważnych problemów, z którymi boryka się Australia, ale nie będziemy w stanie ich rozwiązać w świecie z niekontrolowaną AI. Australia powinna opowiadać się za międzynarodowym traktatem w tym samym czasie, gdy pracuje nad innymi problemami.

### Dlaczego nic nie jest robione? {#why-isnt-anything-being-done-already}

Australijscy politycy zajmowali się niektórymi z mniejszych ryzyk związanych z AI, ale rzadko uznają te większe.

Uznajemy, że nie wszyscy zgadzają się co do ryzyka katastrofy związanej z AI. Odpowiadamy na niektóre z powszechnych zastrzeżeń [tutaj](/faq). Nie twierdzimy, że jesteśmy 100% pewni, ale uważamy, że prawdopodobieństwo bardzo złych skutków jest wystarczająco wysokie, aby uzasadnić wstrzymanie.

Jest [psychologicznie trudno](/psychology-of-x-risk) myśleć o potencjalnych katastrofach. Wiele osób zakłada, że ryzyka są poza ich kontrolą i dlatego nie warto się nimi martwić. Jednak każdy może podjąć działanie już teraz, mówiąc głośno. Uważamy, że lepiej jest działać niż tylko martwić się.
...
#### Grudzień: Politycy podpisują deklarację Superintelligence {#december-politicians-sign-superintelligence-statement}

E-maile od wolontariuszy PauseAI Australia oraz pytanie podczas wydarzenia townhall skłoniły pięciu polityków do podpisania [deklaracji Superintelligence Instytutu Future of Life](https://www.linkedin.com/feed/update/urn:li:activity:7408047524902572032).
Obejrzyj ten moment na townhall [na YouTube](https://youtu.be/SbqUEhJt5RU?si=CSVML0vatdW-GBEh).

#### IABIED Canberra – premiera książki {#iabied-canberra-book-launch}

7 października 2025 roku PauseAI Australia zorganizowało spotkanie i dyskusję na temat premiery książki [_If Anyone Builds It, Everyone Dies_](https://www.penguin.com.au/books/if-anyone-builds-it-everyone-dies-9781847928931) w księgarni Smith's Alternative w Canberze. Laura Nuttall, MLA, i Peter Cain, MLA, wzięli udział w dyskusji i przeczytali fragmenty z książki.
...
[W lipcu 2025 roku](https://drive.google.com/file/d/1t9ntUlF2cZH4_f-1fsp0FFCf3RiGZ81g/view?usp=drive_link) wolontariusz Mark Brown zwrócił uwagę australijskiej policji federalnej i prokuratora generalnego na potencjalne naruszenia _Ustawy o przestępstwach (broniach biologicznych) z 1976 roku_ przez OpenAI. Było to omawiane w [artykule prasowym](https://ia.acs.org.au/article/2025/is-the-new-chatgpt-agent-really-a-weapons-risk-.html) i na [wideo-podcaście](https://youtu.be/-YPhNdpA8Rk). Nadal czekamy na odpowiedź od AFP i prokuratora generalnego.
