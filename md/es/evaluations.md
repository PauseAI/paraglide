---
title: Cómo las evaluaciones y benchmarks de seguridad de la IA pueden ayudar en la gobernanza de la IA
...
En el ámbito de la seguridad de la IA, estas evaluaciones suelen estar diseñadas para medir [capacidades peligrosas](/dangerous-capabilities), como capacidades de ciberseguridad, autorreplicación y investigación de IA autónoma.

Es importante destacar que las evaluaciones pueden determinar si un modelo de IA es demasiado peligroso para ser desplegado.
Existen ciertos límites que ningún modelo de IA debería superar, por ejemplo, cuando puede...

- **autorreplicarse**. (Ej. [RepliBench](https://arxiv.org/abs/2504.18565)). Un modelo de IA que se autorreplica podría escapar de un laboratorio y propagarse a otras máquinas.
- **desarrollar modelos de IA más poderosos**. Ej. [RE-bench](https://metr.org/AI_R_D_Evaluation_Report.pdf). Un modelo de IA que se auto mejora podría volverse rápidamente más poderoso que los humanos.

## Prevenir el despliegue no es suficiente {#preventing-deployment-is-not-enough}
...
La mayoría de las empresas de IA de vanguardia están realizando evaluaciones de seguridad en sus modelos antes de desplegarlos y están incluyendo los resultados de estas evaluaciones en las llamadas "tarjetas de sistema".
...
En otras palabras, **necesitamos regulaciones que exijan evaluaciones de seguridad estandarizadas**.

## Qué están haciendo los países {#what-countries-are-doing}

Varios gobiernos están invirtiendo ahora seriamente en evaluaciones y benchmarks de IA para medir capacidades peligrosas:

- El AISI del Reino Unido ha desarrollado el [marco de inspección](https://github.com/UKGovernmentBEIS/inspect_ai), ha creado [Replibench](https://arxiv.org/abs/2504.18565), y ahora está invirtiendo [15M GBP en subvenciones de investigación de evaluación y alineación](https://alignmentproject.aisi.gov.uk/)
...
- China (concordia AI + laboratorio de IA de Shanghái) acaba de [publicar un informe con numerosas evaluaciones](https://substack.com/home/post/p-169741512)
...
Si estos países e institutos **utilizaran los mismos benchmarks** y tuvieran algunas líneas rojas comunes, eso sería un paso importante hacia un tratado global.
