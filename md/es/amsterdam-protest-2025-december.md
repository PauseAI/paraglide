...
PauseAI exige que ASML solo suministre a clientes que:

- Se comprometan a respetar el moratorio de superinteligencia a través de acuerdos vinculantes
- Se sometan a verificación por una comisión reguladora independiente
- Exijan lo mismo a sus clientes comerciales

De esta manera, se preserva el desarrollo de inteligencia artificial beneficiosa, como la investigación médica, la modelización del clima y el descubrimiento científico, al tiempo que se evita la carrera imprudente hacia la superinteligencia no controlada.

Para obtener más información sobre la cadena de suministro de chips y la posición única de ASML, consulte nuestra página [Construyendo el botón de pausa](https://pauseai.info/building-the-pause-button).